...
class RegressionMetrics(Metrics):
    ...
    def __add__(self, other: "RegressionMetrics") -> "RegressionMetrics":
        ...
        return RegressionMetrics(
            n_samples=self.n_samples + other.n_samples, mse=mse, l1_error=l1_error,
        )
    ...
    def __mul__(self, factor: Union[float, Tensor]) -> "RegressionMetrics":
    ...
    def __rmul__(self, factor: Union[float, Tensor]) -> "RegressionMetrics":
