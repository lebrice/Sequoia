...
from sequoia.common.typed_gym import _Env, _VectorEnv, _Observation_co, _Action, _Reward, _Reward
from .episode import Episode, Observation
from .episode_collector import EpisodeCollector
import gym


class EnvDataset(gym.Wrapper, IterableDataset[Episode[_Observation_co, _Action, _Reward]]):
    def __init__(self, env: _Env[_Observation_co, _Action, _Reward], policy: Policy[_Observation_co, _Action]) -> None:
        super().__init__(env=env)
        self.env = env
        self._episode_generator: Optional[EpisodeCollector[_Observation_co, _Action, _Reward]] = None
        self.policy = policy
...
class EnvDataLoader(DataLoader[Episode[_Observation_co, _Action, _Reward]]):
    def __init__(self, dataset: EnvDataset[_Observation_co, _Action, _Reward], **kwargs):
