...
from sequoia.settings import (Actions, ActiveEnvironment, ActiveSetting,
                              Method, Observations, PassiveEnvironment,
                              PassiveSetting, Rewards, Setting,
...
class PnnMethod(Method, target_setting=TaskIncrementalRLSetting):
    ...
    def get_actions(self,
                    ...
                    action_space: spaces.Space) -> Actions:
...
def main_sl():
    ...
    method: PnnMethod = PnnMethod.from_argparse_args(
        args, dest="method")
