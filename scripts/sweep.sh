...
sbatch --output $OUT --job-name m_mixup_001         ./scripts/sbatch_job.sh --run_name "${NAME}_manifold_mixup_001" $ARGS --manifold_mixup.coef 0.01
sbatch --output $OUT --job-name m_mixup_01          ./scripts/sbatch_job.sh --run_name "${NAME}_manifold_mixup_01"  $ARGS --manifold_mixup.coef 0.1
sbatch --output $OUT --job-name m_mixup_1           ./scripts/sbatch_job.sh --run_name "${NAME}_manifold_mixup_1"   $ARGS --manifold_mixup.coef 1
...
sbatch --output $OUT --job-name vae_01              ./scripts/sbatch_job.sh --run_name "${NAME}_vae_01"             $ARGS --vae.coef 0.1
sbatch --output $OUT --job-name vae_1               ./scripts/sbatch_job.sh	--run_name "${NAME}_vae_1"              $ARGS --vae.coef 1
sbatch --output $OUT --job-name ae_001              ./scripts/sbatch_job.sh --run_name "${NAME}_ae_001"             $ARGS --ae.coef 0.01
sbatch --output $OUT --job-name ae_01               ./scripts/sbatch_job.sh --run_name "${NAME}_ae_01"              $ARGS --ae.coef 0.1
sbatch --output $OUT --job-name ae_1                ./scripts/sbatch_job.sh --run_name "${NAME}_ae_1"               $ARGS --ae.coef 1
