...
#0.05
#sup
##bash sbatch_job_semi.sh 'sup_loss' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc_cf10' 3 --wandb_project SSCL_6_test_005_cifar10_full_3 --semi_setup_full 1 --simclr_augment 0 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_acc --run_name sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0


#sup ewc
#bash sbatch_job_semi.sh 'sup_ewc_loss' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_ewc_loss --use_accuracy_as_metric 0 --random_class_ordering 0
##bash sbatch_job_semi.sh 'sup_ewc_acc' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_ewc_acc_cf10' 3 --wandb_project SSCL_6_test_005_cifar10_full_3 --semi_setup_full 1 --simclr_augment 0 --dataset cifar10 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_ewc_acc --run_name sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0
...
#bash sbatch_job_semi.sh 'ict_ewc_acc_cf10' 3 --wandb_project SSCL_6_test_005_cifar10_full_3 --semi_setup_full 1 --simclr_augment 0 --dataset cifar10 --mixup.coefficient 1 --ewc.coefficient 100  --learning_rate 0.1 --lr_rampdown_epochs 300 --consistency_rampup_starts 1 --mixup_usup_alpha 1.0 --mixup_sup_alpha 0.1 --mixup_consistency 1 --consistency_rampup_ends 100 --multihead 1 --ratio_labelled 0.05 --n_classes_per_task 2  --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_ict_ewc_acc_metric --run_name ict_ewc_acc_metric --use_accuracy_as_metric 1  --random_class_ordering 0
...
#sup
#bash sbatch_job_semi.sh 'sup_loss' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_02 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0

#sup ewc
#bash sbatch_job_semi.sh 'sup_ewc_loss' 3 --wandb_project SSCL_6_test_005 --dataset cifar10 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_ewc_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_ewc_acc' 3 --wandb_project SSCL_6_test_02 --dataset cifar10 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0
...
#SimCLR
#bash sbatch_job_semi.sh 'SimCLR_conv_loss' 3 --wandb_project SSCL_6_test_005  --dataset cifar10 --simclr.coefficient 1 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_simclr_loss_metric --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'SimCLR_conv_acc' 3 --wandb_project SSCL_6_test_02  --dataset cifar10 --simclr.coefficient 1 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar10_simclr_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
