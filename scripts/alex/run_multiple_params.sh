...
bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full_2 --semi_setup_full 1 --simclr_augment 0 --dataset cifar10 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi.sh 'simclr_ict_ewc_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full_2  --dataset cifar10 --mixup.coefficient 1 --ewc.coefficient 100 --simclr.coefficient 1 --double_augmentation 0 --learning_rate 0.1 --lr_rampdown_epochs 300 --consistency_rampup_starts 1 --mixup_usup_alpha 1.0 --mixup_sup_alpha 0.1 --mixup_consistency 1 --consistency_rampup_ends 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_ict_ewc_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
