...
bash sbatch_job_semi_cc.sh 'SimCLR_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1 --dataset cifar10 --simclr.coefficient 1 --double_augmentation 0 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi_cc.sh 'simclr_ewc_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1  --dataset cifar10 --simclr.coefficient 1 --double_augmentation 0 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_ewc_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi_cc.sh 'simCLR_detached_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1  --detach_classifier --dataset cifar10 --simclr.coefficient 1 --double_augmentation 0 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_etached_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi_cc.sh 'simclr_ewc_detached_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1  --detach_classifier  --dataset cifar10 --ewc.coefficient 100 --simclr.coefficient 1 --double_augmentation 0 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_ewc_detached_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi_cc.sh 'simclr_ict_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1  --dataset cifar10 --mixup.coefficient 1 --simclr.coefficient 1 --double_augmentation 0 --learning_rate 0.1 --lr_rampdown_epochs 300 --consistency_rampup_starts 1 --mixup_usup_alpha 1.0 --mixup_sup_alpha 0.1 --mixup_consistency 1 --consistency_rampup_ends 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_ict_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
...
bash sbatch_job_semi_cc.sh 'simclr_ict_ewc_conv_acc' 3 --wandb_project SSCL_6_test_005_cifar10_full --semi_setup_full 1   --dataset cifar10 --mixup.coefficient 1 --ewc.coefficient 100 --simclr.coefficient 1 --double_augmentation 0 --learning_rate 0.1 --lr_rampdown_epochs 300 --consistency_rampup_starts 1 --mixup_usup_alpha 1.0 --mixup_sup_alpha 0.1 --mixup_consistency 1 --consistency_rampup_ends 100 --multihead 1 --n_classes_per_task 2 --ratio_labelled 0.05 --supervised_epochs_per_task 200 --batch_size 128 --run_group simclr_ict_ewc_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
