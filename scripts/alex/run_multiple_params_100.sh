...
#0.2
#sup
##bash sbatch_job_semi.sh 'sup_loss' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_02_full --simclr_augment 0 --dataset cifar100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0 --semi_setup_full 1


#sup ewc
#bash sbatch_job_semi.sh 'sup_ewc_loss' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_ewc_loss --use_accuracy_as_metric 0 --random_class_ordering 0
##bash sbatch_job_semi.sh 'sup_ewc_acc' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_ewc_acc' 3 --wandb_project SSCL_6_test_02_full --simclr_augment 0 --dataset cifar100 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0 --semi_setup_full 1

#ICT
#bash sbatch_job_semi.sh 'ict_loss' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --mixup.coefficient 1 --learning_rate 0.001 --lr_rampdown_epochs 350 --consistency_rampup_starts 1 --mixup_usup_alpha 1. --mixup_sup_alpha 0.01 --mixup_consistency 10 --consistency_rampup_ends 100 --multihead 1 --ratio_labelled 0.2 --n_classes_per_task 20 --supervised_epochs_per_task 200  --batch_size 128 --run_group cifar100_ict_loss_metric_3 --use_accuracy_as_metric 0 --random_class_ordering 0
##bash sbatch_job_semi.sh 'ict_acc' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --mixup.coefficient 1 --learning_rate 0.001 --lr_rampdown_epochs 350 --consistency_rampup_starts 1 --mixup_usup_alpha 1. --mixup_sup_alpha 0.01 --mixup_consistency 10 --consistency_rampup_ends 100 --multihead 1 --ratio_labelled 0.2 --n_classes_per_task 20 --supervised_epochs_per_task 200  --batch_size 128 --run_group cifar100_ict_acc_metric_3 --use_accuracy_as_metric 1 --random_class_ordering 0
...
#sup
#bash sbatch_job_semi.sh 'sup_loss' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_acc' 3 --wandb_project SSCL_6_test_02 --dataset cifar100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_acc --use_accuracy_as_metric 1 --random_class_ordering 0

#sup ewc
#bash sbatch_job_semi.sh 'sup_ewc_loss' 3 --wandb_project SSCL_6_test_01 --dataset cifar100 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_ewc_loss --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'sup_ewc_acc' 3 --wandb_project SSCL_6_test_02 --dataset cifar100 --ewc.coefficient 100 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_sup_ewc_acc --use_accuracy_as_metric 1 --random_class_ordering 0
...
#SimCLR
#bash sbatch_job_semi.sh 'SimCLR_conv_loss' 3 --wandb_project SSCL_6_test_01  --dataset cifar100 --simclr.coefficient 1 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_simclr_loss_metric --use_accuracy_as_metric 0 --random_class_ordering 0
#bash sbatch_job_semi.sh 'SimCLR_conv_acc' 3 --wandb_project SSCL_6_test_02  --dataset cifar100 --simclr.coefficient 1 --multihead 1 --n_classes_per_task 20 --ratio_labelled 0.2 --supervised_epochs_per_task 200 --batch_size 128 --run_group cifar100_simclr_accmetr --use_accuracy_as_metric 1 --random_class_ordering 0
